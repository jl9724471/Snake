...
HD_PWD='C:/Users/jl972/Desktop/HDL/Snake_V3/Snake.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_block_wrapper.tcl
