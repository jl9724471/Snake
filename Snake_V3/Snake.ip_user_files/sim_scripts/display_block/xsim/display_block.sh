...
#
# Script generated by Vivado on Mon Mar 03 09:38:18 +1100 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : display_block.sh
...
#
# Usage        : display_block.sh
#                display_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                display_block.sh [-reset_run]
#                display_block.sh [-reset_log]
#                display_block.sh [-help]
#
...
# script info
echo -e "display_block.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./display_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot display_block xil_defaultlib.display_block xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim display_block -key {Behavioral:sim_1:Functional:display_block} -tclbatch cmd.tcl -protoinst "protoinst_files/display_block.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb display_block.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./display_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: display_block.sh [-help]\n\
Usage: display_block.sh [-step]\n\
Usage: display_block.sh [-lib_map_path]\n\
Usage: display_block.sh [-reset_run]\n\
Usage: display_block.sh [-reset_log]\n\
Usage: display_block.sh [-keep_index]\n\
Usage: display_block.sh [-noclean_files]\n\n\
