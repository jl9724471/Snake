...
(* CORE_GENERATION_INFO = "display_block,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=display_block,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=7,numPkgbdBlks=0,bdsource=USER,\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"da_board_cnt\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"=3,\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"da_clkrst_cnt\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"=3,\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"da_board_cnt\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"=1,\"\"\"\"\"da_clkrst_cnt\"\"\"\"\"=1,\"\"da_board_cnt\"\"=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "display_block.hwdef" *) 
module display_block
  ...
  display_block_VGA_output_0_1 VGA_output_0
       (.BLU(vgaBlue),
        ...
        .RED(vgaRed),
        .VSYNC(Vsync),
        .X_ahead(VGA_output_0_X_ahead),
        .Y_ahead(VGA_output_0_Y_ahead),
  ...
  display_block_memory_mapper_0_0 memory_mapper_0
       (.X(VGA_output_0_X_ahead),
        ...
        .Y_cell(memory_mapper_0_Y_cell),
        .address(memory_mapper_0_adress),
