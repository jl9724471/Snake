...
HD_PWD='C:/Users/jl972/Desktop/HDL/Snake_V3/Snake.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_block_wrapper.tcl -notrace
